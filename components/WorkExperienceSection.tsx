      ...
      {t.workExperience.experiences.map(data => (
        <div key={data.id} className="w-layout-grid grid_list work-experience-grid">
          ...
          <div className="grid_item">
            <HoverText text={data.role} className="text-block" disabled={false} />
            {data.description && (
          ...
          <div className="grid_item">
            <HoverText text={data.company} className="text-block" disabled={false} />
          </div>
          <div className="grid_item">
            <HoverText text={data.period} className="text-block" disabled={false} />
          </div>
        </div>
      ))}
    </div>
